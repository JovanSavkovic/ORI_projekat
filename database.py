...
def writeCreatures(creatures, fileName):
    ...
    for c in creatures:
        ...
        for muscle in c.muscles:
            w_muscles.append({"node_index1" : muscle.node_index1, "node_index2" : muscle.node_index2, "strength" : muscle.strength, "relax_length" : muscle.relax_length, "flexibility" : muscle.flexibility, "switch_times" : muscle.switch_times})
        w_list.append({"nodes" : w_nodes, "muscles" : w_muscles})
